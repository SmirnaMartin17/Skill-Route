    ...
    <div className="min-h-screen bg-secondary text-primary">
            ...
            {isOpen && (
              ...
              >
                <div className="space-y-1">
                  ...
                  <a
                    href="https://github.com/Saunakghosh10/Skill Route"
                    target="_blank"
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            Choose from our curated collection of learning paths designed to
            help you master different areas of software development.
          </motion.p>
            ...
            {[
              {
                ...
                description:
                  "Select from our curated roadmaps tailored to your goals",
              ...
              },
              {
                ...
                description:
                  "Monitor your learning journey with interactive checkpoints",
      ...
      >
        <div className="max-w-7xl mx-auto relative z-10">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">About Skill Route</h2>
            <p className="text-accent max-w-2xl mx-auto">
              Empowering developers through structured learning paths and
            ...
            <motion.div variants={itemVariants} className="space-y-6">
              <div className="space-y-4">
                ...
                <p className="text-accent leading-relaxed">
                  Skill Route is dedicated to revolutionizing developer
                  education by providing clear, structured learning paths that
                  guide you from beginner to expert. We believe in learning by
                  doing, supported by a community of passionate developers.
                </p>
              </div>
              　 　
              <div className="space-y-4">
            ...
            <motion.div variants={itemVariants} className="relative">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
                ...
                >
                  ...
                  <p className="text-sm text-accent">
                    Learn through practical coding exercises
                  </p>
                </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Why Choose Skill Route</h2>
            <p className="text-accent max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <motion.div
              variants={itemVariants}
              className="p-8 bg-secondary rounded-xl border border-gray-medium"
            >
              <h3 className="text-2xl font-bold mb-6">Skill Route Learning</h3>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-accent max-w-2xl mx-auto">
              Monitor your learning journey with our interactive tracking system
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-accent max-w-2xl mx-auto">
              Track your progress, assess your skills, and visualize your
              learning journey
            </p>
          </motion.div>
      ...
      >
        <div className="max-w-7xl mx-auto">
          <motion.div variants={itemVariants} className="text-center mb-16">
            ...
            <p className="text-accent max-w-2xl mx-auto">
              Hear from developers who transformed their careers with Skill
              Route
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                quote:
                  "Skill Route has revolutionized my learning journey. The roadmaps are incredibly well-structured and the interactive features keep me engaged.",
              },
              {
                name: "James Wilson",
                ...
                quote:
                  "The project-based learning approach gave me real-world experience that helped me land my dream job.",
              },
              {
                name: "Maria Garcia",
                ...
                quote:
                  "The DevOps roadmap was exactly what I needed to level up my career. Now I'm leading infrastructure teams.",
              },
            ].map((testimonial) => (
              <motion.div
