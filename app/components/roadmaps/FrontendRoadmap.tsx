    ...
    <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="text-center">
          ...
          >
            Master modern frontend development with our comprehensive learning
            path
          </motion.p>
        </div>
        ...
        <motion.div
          variants={itemVariants}
          className="flex justify-center space-x-4 flex-wrap gap-y-2"
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {topics.map((topic) => (
            <motion.div
              ...
              whileTap={{ scale: 0.98 }}
              className={`p-6 rounded-xl border-2 transition-all ${getLevelColor(
                topic.level
              )} ${
                topic.isCompleted
            ...
            >
              ...
              <p
                className={
                  topic.isCompleted ? "text-secondary/80" : "text-accent"
                }
              >
                {topic.description}
              </p>
              ...
              <div className="mt-4 space-y-2">
                <h4
                  className={`font-medium ${
                    topic.isCompleted ? "text-secondary" : "text-primary"
                  }`}
                >
                  Key Topics:
                </h4>
